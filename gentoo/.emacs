...
(custom-set-faces
 ...
 '(default ((t (:inherit nil :stipple nil :background "black" :foreground "#00ff00" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 103 :width normal :foundry "apple" :family "Monaco")))))
...
'((height . 45) (width . 120) (menu-bar-lines . 20) (tool-bar-lines . 0)))